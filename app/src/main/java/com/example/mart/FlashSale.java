 ...
 * Use the {@link FlashSale#newInstance} factory method to
...
public class FlashSale extends Fragment {
     ...
     * @return A new instance of fragment FlashSale.
     */
    // TODO: Rename and change types and number of parameters
    public static FlashSale newInstance(String param1, String param2) {
        FlashSale fragment = new FlashSale();
        ...
        */
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                itemRV1.setAdapter(new ItemAdapter(getActivity(),items));
                itemRV2.setAdapter(new ItemAdapter(getActivity(),items));
                itemRV3.setAdapter(new ItemAdapter(getActivity(),items));
                itemRV4.setAdapter(new ItemAdapter(getActivity(),items));
